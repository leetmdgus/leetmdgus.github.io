...
void _rand(int & num){ // 100~999 랜덤 숫자 생성
    int hund, ten, one;
    srand(time(NULL));
...
~~~
your number: 123	//숫자 결정
number: 123		//숫자추측
0s 0b			//추측결과
651		0s 1b	//프로그램이 사용자 숫자 추측
number: 789
3s 0b
you win
~~~
...
+ 우리가 해야 할 것
  ...
  + 객체지향형식으로 프로그램을 구현해보자.
  + brute force 알고리즘말고 새로운 알고리즘을 생각해보자.

  + 랜덤을 사용하지 않고 만드는 방법을 생각해보자.
